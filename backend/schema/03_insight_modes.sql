-- ============================================================================
-- [DEPRECATED] 此文件已废弃，请使用迁移系统
-- ============================================================================
-- 新位置: schema/migrations/V005__insight_modes.sql
-- 执行方式: uv run python scripts/run_migrations.py
-- ============================================================================

-- ====================================================================
-- Insight Modes (分析模式) 配置表
-- 用于动态管理 System Prompt Mode，替代硬编码的 MODE_PROMPTS
-- ====================================================================
